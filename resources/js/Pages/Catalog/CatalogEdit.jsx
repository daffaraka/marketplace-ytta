...
export default function CatalogEdit({ auth, product, categories }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('catalog.update', product.id), { forceFormData: true });
    };

    return (
        <AuthenticatedLayout user={auth.user} header="Edit Menu">
            <Head title="Edit Menu" />
            <div id="page-catalog-edit">
            ...
            <div id="section-catalog-edit-form" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-3xl">
                <form onSubmit={submit} className="p-6 md:p-8 space-y-6">
                    ...
                    <div id="section-catalog-edit-actions" className="flex justify-end space-x-3 pt-6 border-t border-gray-100">
                        <Link
                            href={route('catalog')}
