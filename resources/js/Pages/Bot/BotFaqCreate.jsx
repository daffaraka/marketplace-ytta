...
export default function BotFaqCreate({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('bot.faq.store'));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Tambah FAQ Baru</h2>}
        >
            <Head title="Tambah FAQ Baru" />

            <div id="page-bot-faq-create" className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div id="section-bot-faq-create-form" className="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100">
                        <div className="p-6 sm:p-8">
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div id="section-bot-faq-create-actions" className="flex justify-end pt-4">
                                    <button
                                        type="submit"
                                        disabled={processing}
